...
class InspectorTests(unittest.TestCase):
    ...
    def test_invalid_symbols_do_not_compile(self):
        self.page.click('#build-profile'); self.page.get_by_label('Additional C# symbols').fill('BAD-SYMBOL')
        self.page.get_by_role('button', name='Apply & build').click()
    ...
    def test_mobile_dialog_fits_viewport(self):
        self.page.set_viewport_size({'width':390,'height':844});self.page.click('#build-profile')
    ...
    def test_project_selection_and_disposal(self):
        ...
        self.page.click('#build-profile');self.page.get_by_label('Evaluated project',exact=True).select_option('Lib.csproj')
