...
class WorkbenchTests(unittest.TestCase):
    ...
    def palette(self,shortcut,text):
        ...
        fill(self.page,'#wb-palette-query',text)
    ...
    def test_find_replace_changes_actual_compiled_handler(self):
        ...
        fill(self.page,'#wb-find','count += 1');fill(self.page,'#wb-replace','count += 7')
        click(self.page,'#wb-replace-all');click(self.page,'#wb-find-close');click(self.page,'#run')
    ...
    def test_generated_javascript_is_searchable_but_not_replaced(self):
        ...
        self.page.keyboard.press('Control+h');fill(self.page,'#wb-find','function');fill(self.page,'#wb-replace','bad')
        expect(self.page.locator('#wb-replace-all')).to_be_disabled()
        click(self.page,'#wb-find-close');self.page.locator('#editor').focus();self.page.keyboard.press('Tab')
    ...
    def test_caret_restore_go_to_line_and_comment_transaction(self):
        ...
        self.page.keyboard.press('Control+g');fill(self.page,'#wb-palette-query','16:9');self.page.keyboard.press('Enter')
    ...
    def test_keyboard_splitters_dock_and_reset_layout(self):
        ...
        resize=self.page.get_by_role('separator',name='Resize right tool windows',exact=True)
        ...
        self.assertEqual(int(resize.get_attribute('aria-valuenow')),302)
