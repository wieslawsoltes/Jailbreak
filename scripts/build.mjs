...
const offline=moduleHtml.replace('<link rel="stylesheet" href="./style.css">',()=>'<style>'+css+'</style>').replace('<script type="module" src="./app.js"></script>',()=>'<script>globalThis.__JailbreakAssets='+JSON.stringify(assets).replace(/</g,'\u003c')+';</script><script>'+app.replace(/<\/script/gi,'<\\/script')+'</script>');
