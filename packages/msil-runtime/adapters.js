...
for(const t of ['int32','float64'])for(const [name,fn,n]of [['Abs',Math.abs,1],['Min',Math.min,2],['Max',Math.max,2]])add('System.Math',name,Array(n).fill(t),t,(_,args)=>{if(t==='int32'&&name==='Abs'&&args[0]===-2147483648)throw new RangeError('OverflowException');return fn(...args);});
