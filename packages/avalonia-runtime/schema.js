...
export const controlDefinitions = {
  ...
  Button:'Content Command CommandParameter IsDefault IsCancel ClickMode', RepeatButton:'Content Command CommandParameter Delay Interval', ToggleButton:'Content IsChecked IsThreeState Command CommandParameter',
  ...
  Slider:'Value Minimum Maximum TickFrequency IsSnapToTickEnabled Orientation', ProgressBar:'Value Minimum Maximum IsIndeterminate ShowProgressText Orientation',
